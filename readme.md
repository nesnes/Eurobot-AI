...
- Install compilation and execution requirments with `sudo apt install -y build-essential cmake libcairo2-dev libpango1.0-dev libjpeg-dev libgif-dev librsvg2-dev mpg321` or `brew install pkg-config cairo pango libpng jpeg giflib librsvg pixman python-setuptools`
